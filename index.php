    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <div class="alert alert-primary" role="alert">
                ...
                <a href="https://ead.ifms.edu.br/"><img src="./arquivos/imagens/ms.png" class="card-img-top " alt="..."></a>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <a href="https://chrome.google.com/webstore/detail/adblock-master/aalliemglapliaagpcgcjkcmidodoicc"><img src="./arquivos/imagens/todd.jpeg" class="card-img-top" alt="..."></a>
                    <div class="card-body">
