<?php
$path = 'http://' . $_SERVER["HTTP_HOST"] . '/TABWEB';
?>
<nav class="navbar navbar-expand-lg bg-body-tertiary  p-3 text-dark-emphasis bg-dark-subtle border border-primary-subtle rounded-3"">
