...
<body>
    ...
    <div class="progress" role="progressbar" aria-label="Info example" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
    ...
    <div class="d-flex position-relative" style="max-width: 540rem;">
        ...
        <div>
            ...
            <h5 class="mt-0">Última semana para inscrições em curso de Eletricista</h5>
            <div class="text-bg-dark p-3">
                Curso de Eletricista de Sistemas de Energias Renováveis será ofertado nos campi Campo Grande e Três Lagoas. Estudantes receberão ajuda de custo de R$ 800<br>
                O Instituto Federal de Mato Grosso do Sul (IFMS) recebe até sábado, 13, asinscrições no processo seletivo para ingresso no curso de Eletricista de Sistemas de Energias Renováveis, ofertado gratuitamente por meio do Programa Qualifica Mais Energif.<br>
                ............<br>
